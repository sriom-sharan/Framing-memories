  ...
  return (
    <DefaultLayout>
      <div className="bg-accent mx-auto pt-16">
        <div className="relative h-96  bg-blend-multiply bg-opacity-60  bg-black bg-right-bottom bg-cover bg-[url(https://images.unsplash.com/photo-1612278675615-7b093b07772d?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)]">
          ...
          <h2 className="md:text-7xl absolute translate left-1/2 -translate-x-1/2 -translate-y-1/2 top-1/2 text-center  text-white font-medium text-5xl md:pt-6 py-2">
            About Us
          </h2>
        </div>

        <div className="max-w-5xl mx-auto py-10 pb-16 px-7">
          <p className=" pb-4">
